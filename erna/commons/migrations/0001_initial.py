...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method_name', models.CharField(choices=[('GAL', 'genome alignment'), ('DSA', 'DNA sequence alignment'), ('GAS', 'genome assembly'), ('CR', 'count reads'), ('TS', 'trim sequences'), ('QC', 'quality control'), ('CFF', 'convert file format')], max_length=20)),
